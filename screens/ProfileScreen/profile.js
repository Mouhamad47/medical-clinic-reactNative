...
export default function Profile({ navigation }) {
    ...
    const [nbOfPatients, setNbOfPatients] = useState(null);
    ...
    const getNbOfPatients = async () => {
        api.selectNumberOfPatients().then((response) => {
            setNbOfPatients(response.data)
                    ...
                    <View style={styles.info}>
                        ...
                        {nbOfPatients &&
                            <View style={[styles.majorsection, { marginTop: 25 }]}>
                                ...
                                <Text style={styles.majorText}> Consultations: {nbOfPatients} </Text>
                            </View>
                        }
